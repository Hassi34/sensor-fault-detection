...
TIMESTAMP_INT : int = round(datetime.now().timestamp())
...
class ModelEvaluationConfig:
    ...
    report_file_path : str = os.path.join(model_evaluation_dir, MODEL_EVALUATION_REPORT_FIEL_NAME)
...
class ModelPusherConfig:
    model_evaluation_dir : str = os.path.join(training_pipeline_config.artifact_dir, MODEL_PUSHER_DIR_NAME)

    model_file_path : str = os.path.join(model_evaluation_dir, MODEL_FILE_NAME)
